  ...
  return (
    <section className={`section ${styles.section}`} aria-labelledby="products-heading">
      <div className="site-container">
        <div className={styles.heading}><div><h2 id="products-heading">Product Expertise</h2></div><Link href="/products" className="btn btn--secondary">Explore All Products <span aria-hidden="true">↗</span></Link></div>
