    ...
    <section className={styles.hero} aria-labelledby="hero-heading">
      <div className={`site-container ${styles.grid}`}>
        <div className={styles.content}>
          <p className={`eyebrow ${styles.eyebrow}`}><span aria-hidden="true" /> Science with purpose</p>
        ...
        <figure className={styles.visual}>
          ...
          <figcaption className={styles.caption}><span className={styles.captionNumber}>01 — 03</span><span>Concept <span aria-hidden="true">→</span> Development <span aria-hidden="true">→</span> Commercialization</span></figcaption>
        </figure>
      </div>
    </section>
  );
